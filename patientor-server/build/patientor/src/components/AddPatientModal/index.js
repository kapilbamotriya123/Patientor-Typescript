...
const AddPatientModal = ({ modalOpen, onClose, onSubmit, error, setError }) => (<material_1.Dialog fullWidth={true} open={modalOpen} onClose={() => onClose()}>
    ...
    <material_1.DialogContent>
      ...
      <AddPatientForm_1.default onSubmit={onSubmit} onCancel={onClose} setError={setError}/>
    </material_1.DialogContent>
  </material_1.Dialog>);
